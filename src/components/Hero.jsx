    ...
    >
      <div className=" px-4 sm:px-10 lg:w-[1000px] mx-auto">
        <div className="grid lg:grid-cols-2 lg:text-left">
          <img
            className="sm:w-[280px] w-[220px] lg:mr-0 shadow-lg rounded-2xl mx-auto lg:order-2"
            src={Image}
            alt="/"
          />
          <div className=" sm:max-w-[500px] mx-auto lg:order-1">
            ...
            <p className="text-gray-500 mb-7 text-[18px]">
              Hi, I'm Wassim Chmeis.{" "}
              <Typed
                strings={[
                  "A passionate Front-end React Developer based in Beirut, Lebanon. 📍",
                ]}
                typeSpeed={30}
                showCursor={false}
              />
